...
In an unsafe context, a local variable declaration ([§12.6.2](statements.md#1262-local-variable-declarations)) may include a stack allocation initializer, which allocates memory from the call stack.
